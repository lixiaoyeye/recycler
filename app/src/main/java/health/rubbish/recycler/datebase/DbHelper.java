...
public class DbHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS "+TRASH_TABLE+" (id INTEGER PRIMARY KEY AUTOINCREMENT," +
                "trashid VARCHAR(100),date VARCHAR(100),rfidno VARCHAR(100),trashcode  VARCHAR(100),trashcancode  VARCHAR(100),status  VARCHAR(100)," +
                ...
                "dustybincode VARCHAR(100),transfertime  VARCHAR(100)," +
